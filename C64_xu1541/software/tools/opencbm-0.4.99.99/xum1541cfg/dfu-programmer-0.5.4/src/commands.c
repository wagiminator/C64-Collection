                                     ...
                                     struct programmer_arguments *args )
{
    ...
    for( i = args->bootloader_bottom; i <= (int)args->bootloader_top; i++) {
        if( -1 != hex_data[i] ) {
                                  ...
                                  struct programmer_arguments *args )
{
    ...
    if( 0 != atmel_set_fuse(device, (uint8_t)name, value) )
    {
                                  ...
                                  struct programmer_arguments *args )
{
    ...
    if( 0 != atmel_set_config(device, (uint8_t)name, (uint8_t)value) )
    {
