#!/usr/bin/env python3
# ===================================================================================
# Project:   DiskMaster64 - Python Script - Format Disk
# Version:   v1.0
# Year:      2022
...
parser.add_argument('-v', '--verify', action='store_true', help='verify each track after it is written')
